<template>
  <div class="min-h-screen bg-canvas">
    ...
    <header class="sticky top-0 z-30 border-b border-border bg-surface/85 backdrop-blur-md">
      <div class="mx-auto flex h-16 max-w-6xl items-center gap-3 px-4 sm:px-6 lg:px-8">
        <RouterLink
          to="/dashboard"
          class="flex shrink-0 items-center gap-2 rounded-lg font-semibold tracking-tight text-content"
        >
